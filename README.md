...
Периодическое начисление - в ТЗ не нашел бизнес-логику с периодическим начислением, cron-job и т.д., поэтому в реализации: время обработки ивента по сути это время начисления
